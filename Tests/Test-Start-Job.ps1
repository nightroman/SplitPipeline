...
.Description
	...
	The sample jobs would take ~20 seconds when run sequentially.
	With Split-Pipeline and Start-Job they take ~7 seconds.
...
$data = 1..20 | Split-Pipeline -Count 4 {process{
