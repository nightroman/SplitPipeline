...
.Description
	The script downloads SplitPipeline.zip to the current location and extracts files
	to the new directory SplitPipeline. If these items exist remove them manually or
